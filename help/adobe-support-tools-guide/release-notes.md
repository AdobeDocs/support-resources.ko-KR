...
1. 서비스 케이스 만들기 인터페이스는 마지막으로 선택한 경험인 **[!UICONTROL 클래식 양식]** 또는 **[!UICONTROL AI 채팅]**&#x200B;을(를) 기억합니다. **[!UICONTROL AI 채팅]**&#x200B;을(를) 가장 최근에 사용한 경우 다음에 사례를 만들 때 자동으로 선택되므로 방문할 때마다 수동으로 전환할 필요가 없습니다.
1. 첨부 파일은 각 첨부 파일에 표시된 삭제 아이콘을 사용하여 **[!UICONTROL 사례 세부 정보]** 페이지에서 직접 삭제할 수 있습니다. 이 기능은 폐쇄된 사례 또는 Workfront 조직에서는 사용할 수 없습니다.
1. **[!UICONTROL 내 사례]** 페이지의 모든 열에서 정렬이 지원됩니다.
1. **[!UICONTROL AI 권장 사항]**&#x200B;은 사례를 만드는 동안 **[!UICONTROL Admin Console]**&#x200B;을(를) 제품으로 선택하면 사용할 수 있습니다.
