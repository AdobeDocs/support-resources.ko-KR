---
user-guide-title: Adobe 지원 및 도구 안내서
user-guide-description: Adobe 지원 및 도구에 대한 자세한 지침 및 업데이트입니다.
...
- {hide-from-toc}[Adobe 지원 음성 지원 — 일과 후 및 주말 지원(일본)](/help/adobe-support-tools-guide/adobe-support-voice-assistant.md)
- Adobe Admin Console {#adobe-admin-console}
  ...
  - [ID 및 SSO(Single Sign-On) 설정](adobe-admin-console/adobe-set-up-identity-and-sso.md)
  - [Adobe Admin Console 사용자](adobe-admin-console/adobe-admin-console-users.md)
...
- Adobe Commerce 지원 {#adobe-commerce-support}
  ...
  - [Adobe에서 제공하는 격리된 패치를 적용하는 방법](adobe-commerce-support/how-to-apply-an-isolated-security-patch-file-provided-by-adobe.md)
