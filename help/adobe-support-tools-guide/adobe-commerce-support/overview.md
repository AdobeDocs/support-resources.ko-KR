...
* [!DNL Quality Patches Tool]&#x200B;(QPT)
   ...
   * [QPT 도구 개요에서 사용할 수 있는 패치](https://experienceleague.adobe.com/ko/docs/commerce-operations/tools/quality-patches-tool/patches-available-in-qpt/patches-available-in-qpt-tool-overview)
