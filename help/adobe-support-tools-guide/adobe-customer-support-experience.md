...
자세한 내용은 관리 역할 설명서의 [Enterprise 관리자 역할 편집](adobe-admin-console/admin-roles.md#add-enterprise-role) 지침을 따르십시오. 조직의 시스템 관리자만 이 역할을 할당할 수 있습니다. 관리 계층에 대한 자세한 내용은 [관리 역할](adobe-admin-console/admin-roles.md) 설명서를 참조하십시오.
