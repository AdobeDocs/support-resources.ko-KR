...
[Experience League](https://experienceleague.adobe.com/home#support)에서 지원 티켓을 제출하려면 시스템 관리자가 지원 관리자 역할을 할당해야 합니다. 조직의 시스템 관리자만 이 역할을 할당할 수 있습니다. 제품, 제품 프로필 및 기타 관리 역할은 지원 관리자 역할을 할당할 수 없으며 지원 티켓을 제출하는 데 사용되는 **[!UICONTROL 사례 만들기]** 옵션을 볼 수 없습니다. 다양한 유형의 관리자 역할과 해당 권한에 대한 자세한 내용은 [관리자 역할](admin-roles.md)을 참조하세요.
...
1. **[!UICONTROL 홈]** 메뉴에서 **[!UICONTROL 지원 티켓 열기]**, **[!UICONTROL 사례 보기 및 관리]**, **[!UICONTROL 콜백 요청]**&#x200B;하거나 추가 학습 리소스에 액세스할 수 있습니다.
   ...
   **[!UICONTROL 콜백 요청]** 옵션을 사용하면 화면 공유로 웹 모임을 예약하여 보다 빠르고 효율적인 문제 해결을 수행할 수 있습니다. Adobe Experience Manager, Campaign 및 Workfront에서 사용할 수 있습니다. 고객의 편리한 시간에 미팅을 예약할 수 있으며, 즉석 초대가 제공됩니다. Adobe Experience Manager P1 사례의 경우 즉각적인 콜백이 보장되므로 중요한 문제 중에 신속하게 대처할 수 있으므로 다운타임과 비즈니스 영향을 최소화하는 데 도움이 됩니다.
...
**[!UICONTROL 지원 티켓 열기]** 또는 **[!UICONTROL 티켓 열기]**&#x200B;를 선택하면 서비스 케이스 만들기 양식이 나타납니다.

이 양식에서는 문제를 효율적으로 해결하기 위해 Adobe 지원에 필요한 정보를 제공하는 데 도움이 되는 안내식 여러 단계 워크플로우를 사용합니다. 다음 섹션을 사용하여 양식을 이동할 수 있습니다.
...
서비스 케이스를 제출하기 전에 정보를 업데이트하려면 **섹션 간을 전환**&#x200B;할 수도 있습니다.
...
1. **[!UICONTROL 문제 설명]** 섹션에서 문제에 대한 설명을 입력하십시오. 사례 제목은 문제 설명을 기반으로 자동으로 생성됩니다. 필요한 경우 제목을 편집할 수 있습니다. 문제를 재현할 수 있는지 확인합니다. 문제가 재현될 수 있는 경우 **예**&#x200B;를 선택하십시오. 문제를 재현하는 데 필요한 단계를 설명할 수 있는 텍스트 상자가 나타납니다. 문제를 일관되게 재현할 수 없는 경우 **아니요**&#x200B;를 선택하십시오.

   ![Experience league 문제 설명](./assets/problem-description.png)
   ...
   * 일반적인 문제에 대한 사례 제출의 필요성 감소
   ...
   >[!NOTE]
   >
   >권장 사항을 생성하려면 **문제 설명에 최소 50자 이상**&#x200B;이 포함되어야 합니다. 실시간 문자 카운터는 최소 요구 사항을 추적하는 데 도움이 됩니다.

   ![Experience league 문제 세부 정보](./assets/ai-recommendations.png)

1. **[!UICONTROL 다음]**&#x200B;을 클릭합니다.

   ![다음 옵션 클릭](./assets/click-next.png)

1. **[!UICONTROL 시스템 정보]** 섹션에서 **[!UICONTROL 제품 버전]**, **[!UICONTROL 환경]**, **[!UICONTROL 제품 제공]**&#x200B;을 제공하고 환경 또는 인스턴스에 최근 변경 사항이 있는지 여부를 나타냅니다. 변경 내용에 대한 추가 세부 정보를 제공하려면 **예**&#x200B;를 선택하십시오. 변경 사항이 없으면 **아니요**&#x200B;를 선택하고 **[!UICONTROL 다음]**&#x200B;을 클릭합니다.
...
1. **[!UICONTROL 우선 순위 및 비즈니스 영향]** 섹션에서 다음을 선택합니다.
   * 사례 우선 순위(P4 - 사내, P3 - 중요, P2 - 긴급, P1 - 중요)
   * 선택한 우선 순위가 P1 - 위험 수준인 경우 비즈니스 영향 세부 정보를 제공한 다음 **[!UICONTROL 다음]**&#x200B;을 클릭합니다.
...
1. **[!UICONTROL 검토 및 제출]** 섹션에서 사례 세부 정보를 검토하고 **[!UICONTROL 사례 승인 및 제출]**&#x200B;을 클릭하세요.

   ![Experience league 검토 및 제출](./assets/submit-case.png)
