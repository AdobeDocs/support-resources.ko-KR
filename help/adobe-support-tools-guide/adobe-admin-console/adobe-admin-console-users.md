...
- 타사 도구 사용:
  ...
  - [Microsoft SCCM(System Center Configuration Manager)](https://helpx.adobe.com/enterprise/kb/deploy-packages-using-sccm.html)
  - [Apple 원격 데스크탑(ARD)](https://helpx.adobe.com/enterprise/kb/deploy-packages-using-ard.html)
  - [JAMF 프로](https://helpx.adobe.com/enterprise/kb/deploy-packages-using-jamf-pro.html)
  - [문기](https://helpx.adobe.com/enterprise/kb/deploy-packages-using-munki.html)
...
- [제품 프로필에 사용자 할당(기업 및 기관용)](https://helpx.adobe.com/enterprise/using/manage-product-profiles.html#assign-users)
- [팀 사용자에게 라이선스 할당](https://helpx.adobe.com/enterprise/using/assign-licenses-to-teams-users.html)
- [비즈니스 스토리지 모델](https://helpx.adobe.com/enterprise/kb/business-storage-model-introduction.html)
