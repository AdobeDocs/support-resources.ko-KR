...
조직은 Adobe 제품 및 사용자를 관리하는 데 사용되는 구조입니다. [[!DNL Adobe Admin Console]](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/admin-console-overview)을(를) 통해 관리자는 조직의 제품 및 사용자의 배포 및 구성을 관리할 수 있습니다. [[!DNL Global Admin Console]](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/adopt-global-administration)을(를) 사용하면 전역 관리자가 여러 조직을 만들고 관리하고 삭제할 수 있습니다.
...
[전역 관리자](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-administrators)로서 사용자가 [[!DNL Creative Cloud]]개의 제품 및 서비스에 로그인할 때 올바른 프로필을 식별하는 데 도움이 되도록 상위 또는 하위 조직의 이름을 편집할 수 있습니다.
