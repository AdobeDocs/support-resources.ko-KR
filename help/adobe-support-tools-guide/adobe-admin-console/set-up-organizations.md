...
[전역 관리자](https://experienceleague.adobe.com/ko/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-administrators)로서 사용자가 Creative Cloud 제품 및 서비스에 로그인할 때 올바른 프로필을 식별하는 데 도움이 되도록 상위 또는 하위 조직의 이름을 편집할 수 있습니다.
...
[전역 관리자](https://experienceleague.adobe.com/ko/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-administrators)로서 **[!UICONTROL 계층 변경]** 단추를 사용하여 조직 계층에서 조직의 상위 항목을 다시 지정할 수 있습니다.
