...
[전역 관리자](https://helpx.adobe.com/kr/enterprise/global-admin-console/manage-administrators.html)로서 하위 조직을 삭제할 수 있습니다. 삭제 작업은 실행 취소할 수 없으며 루트 조직을 삭제할 수 없습니다. 삭제된 조직에 할당된 리소스는 상위 조직으로 반환됩니다. 조직이 삭제되기 전에 해당 상위 조직은 자동으로 하위 조직의 상위 조직이 됩니다.
