...
글로벌 관리자는 조직을 만들고, 제품 및 스토리지와 같은 리소스를 해당 조직에 배포하고, ID 설정을 관리하고, 조직 정책 템플릿을 만들고 적용할 수 있습니다. 글로벌 관리자가 조직에 추가한 시스템 관리자는 사용자에게 제품을 할당하고 사용자를 온보딩하며 제품 프로필을 만들고 관리하며 해당 조직 내에서 다른 관리 작업을 수행할 수 있습니다.
...
1. **[!UICONTROL 관리자 추가]**&#x200B;를 선택합니다.
   ...
   ![전역 관리 콘솔 관리자 추가](../assets/global-admin-console-add-admin.png)
...
1. **[!UICONTROL 관리자 권한]** 섹션에서 관리자 역할을 하나 이상 선택하십시오.
   ...
   ![전역 관리 콘솔 관리자 추가](../assets/global-admin-console-add-admin-detail.png)
...
관리자가 추가되면 자신의 역할을 수락하고 Admin Console에 대한 링크를 제공할 수 있도록 초대하는 이메일 메시지를 받게 됩니다. 전역 관리자와 다른 역할로 모두 추가된 경우 두 개의 초대를 받게 되며 그중 한 개는 전역 관리 콘솔에, 다른 한 개는 Admin Console에 초대됩니다.
...
1. 관련 관리자에 대한 **[!UICONTROL 추가 옵션]**(⋮) 아이콘을 선택한 다음 **[!UICONTROL 관리자 편집]**&#x200B;을 선택합니다.
   ...
   ![전역 관리 콘솔 관리 권한 편집](../assets/global-admin-console-edit-admin-right.png)
...
1. 관련 관리자에 대한 **[!UICONTROL 추가 옵션]**(⋮) 아이콘을 선택한 다음 **[!UICONTROL 관리자 권한 제거]**&#x200B;를 선택합니다.
   ...
   ![전역 관리 콘솔 관리 권한 제거](../assets/global-admin-console-remove-admin-right.png)
