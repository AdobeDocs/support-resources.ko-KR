...
Global Admin Console에서 조직을 선택하고 **[!UICONTROL 관리자]** 탭으로 이동하여 관리자 권한을 추가, 편집 또는 제거할 수 있습니다. 자세한 내용은 [전역 관리 채택](https://helpx.adobe.com/enterprise/global-admin-console/adopt-global-administration.html)을 참조하세요. [Admin Console에 로그인](https://adminconsole.adobe.com)하려면 여기로 이동하세요.
