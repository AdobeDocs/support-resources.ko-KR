...
5. 보고서를 월별 또는 연도별로 집계할지 여부를 선택합니다.
6. 사용자 지정 날짜 범위를 선택하거나 사전 설정 옵션 중에서 선택합니다. 2020년 6월 18일부터 2020년 6월 18일까지, 계약 시작 날짜 이전에 시작하지 않는 한 그 전날까지의 시작 날짜를 선택할 수 있습니다.
7. 보고서를 CSV 파일로 내보내려면 **[!UICONTROL 다운로드]**&#x200B;를 선택하십시오.
