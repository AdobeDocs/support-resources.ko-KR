...
- [제품 프로필 관리](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-product-profiles)
...
[콘솔 설정](https://helpx.adobe.com/enterprise/using/console-settings.html)을 사용하여 최종 사용자가 문제가 발생하거나 지원이 필요한 경우 지원을 받는 방법에 대해 최종 사용자와 통신할 수 있도록 사용자 지정 메모를 추가할 수 있습니다.
...
관리자는 최종 사용자가 폴더, 파일 및 라이브러리와 같은 회사 에셋으로 작업하는 방법에 대한 자세한 보고서를 다운로드할 수 있습니다. 이러한 보고서를 [콘텐츠 로그](https://helpx.adobe.com/enterprise/using/content-logs.html)라고 합니다.
