...
[[!UICONTROL 콘솔 설정]](https://helpx.adobe.com/enterprise/using/console-settings.html)을 사용하여 최종 사용자가 문제가 발생하거나 지원이 필요한 경우 지원을 받는 방법에 대해 최종 사용자와 통신할 수 있도록 사용자 지정 메모를 추가할 수 있습니다.
