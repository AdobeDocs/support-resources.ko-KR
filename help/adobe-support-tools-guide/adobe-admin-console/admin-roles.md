...
1. **[[!UICONTROL Adobe Admin Console]](https://adminconsole.adobe.com/)**&#x200B;에서 **[!UICONTROL 사용자]** > **[!UICONTROL 관리자]**&#x200B;를 선택합니다.
...
1. **[!UICONTROL Adobe Admin Console]**&#x200B;에서 **[!UICONTROL 사용자]** > **[!UICONTROL 관리자]**&#x200B;를 선택합니다.

   기존 관리자 목록이 표시됩니다.

1. **[!UICONTROL 관리자 추가]**&#x200B;를 클릭합니다.

   **[!UICONTROL 관리자 추가]** 화면이 표시됩니다.
...
Teams 조직의 모든 사용자는 Business ID 사용자이므로 `message@adobe.com`에서 새 관리 권한과 관련된 전자 메일 초대를 받습니다.
...
1. **[!UICONTROL Adobe Admin Console]**&#x200B;에서 **[!UICONTROL 사용자]** > **[!UICONTROL 관리자]**&#x200B;를 선택합니다. 기존 관리자 목록이 표시됩니다.
...
관리자 권한을 취소하려면 사용자를 선택한 다음 **[!UICONTROL 관리자 제거]**&#x200B;를 클릭하십시오.
