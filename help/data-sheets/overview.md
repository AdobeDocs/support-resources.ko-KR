...
| **Mentor Sessions 추가 기능**<br>&#x200B;적시 교육 방식으로 기술 기반의 학습 과정을 제공합니다. | ![사용 불가 아이콘](assets/Cross_red_circle.svg){width="20"} 사용 불가 | ![사용 가능한 아이콘](assets/green_checkmark.svg){width="20"} 포함됨 |
| **Developer Boost 추가 기능**<br>&#x200B;파손 수리 작업을 지원할 수 있는 필드 엔지니어링 전문가에 대한 액세스를 제공합니다. | ![사용 불가 아이콘](assets/Cross_red_circle.svg){width="20"} 사용 불가 | ![포함된 아이콘](assets/green_checkmark.svg){width="20"} 포함됨 |
