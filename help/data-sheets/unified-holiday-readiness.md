...
## Adobe Experience Platform (AEP) 휴일 준비 안내서
...
## Adobe Journey Optimizer (AJO) 휴일 준비 안내서

+++**Adobe Journey Optimizer(AJO) 보류 준비 권장 사항을 보려면 클릭하세요.**
...
## Customer Journey Analytics (CJA) 휴일 준비 안내서
...
[계획 및 피벗: Adobe Commerce(및 선택 사항인 Adobe Experience Cloud 도구)를 사용하여 실행 가능한 전략을 제공하는 2025년 성수기에 대한 전략적 접근](https://experienceleague.adobe.com/en/perspectives/planning-and-pivoting-a-strategic-approach-to-peak-season-2025) 안내서의 권장 사항을 따라 가장 바쁜 시기에 뛰어난 고객 경험을 계획, 피벗 및 제공할 수 있습니다.
...
## Adobe Experience Manager(AEM) Cloud Services 준비 안내서

+++**Adobe Experience Manager(AEM) 클라우드 서비스 준비 권장 사항을 보려면 클릭하세요.**
