...
![수정](../adobe-success-portal/assets/fix.svg) 더 빠르게 탐색할 수 있도록 **[!UICONTROL 행동 계획]**&#x200B;와 **[!UICONTROL 결과 추적기]**&#x200B;의 필터 내에 검색 기능을 추가했습니다.


![수정](../adobe-success-portal/assets/fix.svg) 빠른 컨텍스트를 위해 각 결과에 도구 설명을 추가했습니다.

![수정](../adobe-success-portal/assets/fix.svg) 결과와 사례로부터 다운로드한 PDF에 Adobe 브랜딩을 추가했습니다.
...
![수정](../adobe-success-portal/assets/fix.svg) KBO 세부 정보와 **[!UICONTROL 결과 추적기]** 페이지의 **[!UICONTROL 사용 사례]** 정렬이 일관적이지 않은 문제를 해결했습니다.

![수정](../adobe-success-portal/assets/fix.svg) 사례 제목 위에 마우스를 올릴 때 사례 목록 페이지의 도구 설명에 전체 사례 이름이 표시되지 않는 문제를 해결했습니다.

![수정](../adobe-success-portal/assets/fix.svg) Safari 브라우저에서 뒤로 화살표 아이콘이 비정상적으로 표시되는 문제를 해결했습니다.
